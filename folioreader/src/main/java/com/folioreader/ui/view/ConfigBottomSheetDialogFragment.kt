...
class ConfigBottomSheetDialogFragment : BottomSheetDialogFragment() {
    ...
    private fun configFonts() {
        ...
        view_config_font_sinhala.setTextColor(colorStateList)
        ...
        view_config_font_sinhala.setOnClickListener { selectFont(Constants.FONT_SINHALA, true) }
    ...
    private fun selectFont(selectedFont: Int, isReloadNeeded: Boolean) {
        when (selectedFont) {
            ...
            Constants.FONT_SINHALA -> setSelectedFont(false, false, false, true)
        }
    ...
    private fun setSelectedFont(andada: Boolean, lato: Boolean, lora: Boolean, sinhala: Boolean) {
        view_config_font_andada.isSelected = andada
        view_config_font_lato.isSelected = lato
        view_config_font_lora.isSelected = lora
        view_config_font_sinhala.isSelected = sinhala
